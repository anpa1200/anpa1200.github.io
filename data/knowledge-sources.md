...
| [community](#tag-community) | 22 |
| [container-security](#tag-container-security) | 5 |
| [csirt](#tag-csirt) | 3 |
| [cti](#tag-cti) | 15 |
| [datasets](#tag-datasets) | 5 |
...
| [repositories](#tag-repositories) | 20 |
...
- Maintenance: Active
- Source type: Authoritative Primary
- Access: Free
...
- Tags: [`red-team`](#tag-red-team) [`mitre-attack`](#tag-mitre-attack) [`free`](#tag-free) [`advanced`](#tag-advanced) [`repositories`](#tag-repositories)
...
- Quality: Tier A (95/100)
- Quality dimensions: authority 5/5; originality 5/5; maintenance 4/5; practical value 4.68/5; transparency 5/5
- Evidence use: Primary Authoritative
- Maintenance: Periodic
- Source type: Authoritative Primary
- Access: Free
...
- Tags: [`application-security`](#tag-application-security) [`tools`](#tag-tools) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Tags: [`cti`](#tag-cti) [`freemium`](#tag-freemium) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced) [`tools`](#tag-tools) [`repositories`](#tag-repositories) [`community`](#tag-community)
...
- Quality dimensions: authority 4/5; originality 4/5; maintenance 5/5; practical value 4.8/5; transparency 5/5
- Evidence use: Mixed
- Maintenance: Continuous
- Source type: Authoritative Primary
- Access: Free
...
- Tags: [`detection-engineering`](#tag-detection-engineering) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced) [`tools`](#tag-tools) [`repositories`](#tag-repositories) [`community`](#tag-community)
...
- Tags: [`detection-engineering`](#tag-detection-engineering) [`sigma`](#tag-sigma) [`mitre-attack`](#tag-mitre-attack) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced) [`repositories`](#tag-repositories)
...
- Tags: [`dfir`](#tag-dfir) [`incident-response`](#tag-incident-response) [`free`](#tag-free) [`beginner`](#tag-beginner) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Tags: [`dfir`](#tag-dfir) [`incident-response`](#tag-incident-response) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Tags: [`dfir`](#tag-dfir) [`incident-response`](#tag-incident-response) [`sigma`](#tag-sigma) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Tags: [`dfir`](#tag-dfir) [`incident-response`](#tag-incident-response) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced) [`repositories`](#tag-repositories) [`video`](#tag-video)
...
- Quality dimensions: authority 4/5; originality 4/5; maintenance 5/5; practical value 4.68/5; transparency 5/5
- Evidence use: Mixed
- Maintenance: Continuous
- Source type: Authoritative Primary
- Access: Free
...
- Tags: [`exploit-development`](#tag-exploit-development) [`tools`](#tag-tools) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Quality: Tier A (92/100)
- Quality dimensions: authority 4.5/5; originality 5/5; maintenance 4/5; practical value 4.58/5; transparency 5/5
- Evidence use: Primary Operational
- Maintenance: Periodic
- Source type: Authoritative Primary
- Access: Free
...
- Quality: Tier B (86/100)
- Quality dimensions: authority 4/5; originality 4/5; maintenance 4/5; practical value 4.68/5; transparency 5/5
- Evidence use: Mixed
- Maintenance: Periodic
- Source type: Authoritative Primary
- Access: Free
...
- Tags: [`identity-security`](#tag-identity-security) [`active-directory`](#tag-active-directory) [`freemium`](#tag-freemium) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Tags: [`malware-analysis`](#tag-malware-analysis) [`tools`](#tag-tools) [`reverse-engineering`](#tag-reverse-engineering) [`dfir`](#tag-dfir) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Tags: [`malware-analysis`](#tag-malware-analysis) [`tools`](#tag-tools) [`yara`](#tag-yara) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Tags: [`network-security`](#tag-network-security) [`blue-team`](#tag-blue-team) [`free`](#tag-free) [`beginner`](#tag-beginner) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced) [`books`](#tag-books)
...
- Tags: [`network-security`](#tag-network-security) [`blue-team`](#tag-blue-team) [`suricata`](#tag-suricata) [`detection-engineering`](#tag-detection-engineering) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Tags: [`network-security`](#tag-network-security) [`blue-team`](#tag-blue-team) [`incident-response`](#tag-incident-response) [`free`](#tag-free) [`beginner`](#tag-beginner) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Tags: [`network-security`](#tag-network-security) [`blue-team`](#tag-blue-team) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Quality: Tier A (98/100)
- Quality dimensions: authority 5/5; originality 5/5; maintenance 5/5; practical value 4.58/5; transparency 5/5
- Evidence use: Primary Authoritative
- Maintenance: Continuous
- Source type: Authoritative Primary
- Access: Free
...
- Tags: [`penetration-testing`](#tag-penetration-testing) [`exploit-development`](#tag-exploit-development) [`red-team`](#tag-red-team) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced) [`repositories`](#tag-repositories)
...
- Tags: [`reverse-engineering`](#tag-reverse-engineering) [`free`](#tag-free) [`beginner`](#tag-beginner) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Tags: [`reverse-engineering`](#tag-reverse-engineering) [`malware-analysis`](#tag-malware-analysis) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Tags: [`soc`](#tag-soc) [`blue-team`](#tag-blue-team) [`free`](#tag-free) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Quality: Tier A (96/100)
- Quality dimensions: authority 5/5; originality 5/5; maintenance 4/5; practical value 5/5; transparency 5/5
- Evidence use: Primary Authoritative
- Maintenance: Periodic
- Source type: Authoritative Primary
- Access: Free
...
- Tags: [`training`](#tag-training) [`blue-team`](#tag-blue-team) [`dfir`](#tag-dfir) [`incident-response`](#tag-incident-response) [`malware-analysis`](#tag-malware-analysis) [`freemium`](#tag-freemium) [`beginner`](#tag-beginner) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced) [`labs`](#tag-labs)
...
- Tags: [`training`](#tag-training) [`penetration-testing`](#tag-penetration-testing) [`active-directory`](#tag-active-directory) [`web-security`](#tag-web-security) [`red-team`](#tag-red-team) [`blue-team`](#tag-blue-team) [`freemium`](#tag-freemium) [`beginner`](#tag-beginner) [`intermediate`](#tag-intermediate) [`advanced`](#tag-advanced)
...
- Quality: Tier C (79/100)
- Quality dimensions: authority 3.5/5; originality 3/5; maintenance 4/5; practical value 4.68/5; transparency 5/5
...
[arXiv Cryptography and Security](#arxiv-cryptography-and-security) · [USENIX Security Symposium](#usenix-security-symposium) · [Atomic Red Team](#atomic-red-team) · [garak](#garak) · [Promptfoo](#promptfoo) · [PyRIT](#pyrit) · [Semgrep](#semgrep) · [Prowler](#prowler) · [Stratus Red Team](#stratus-red-team) · [Trivy](#trivy) · [MISP](#misp) · [OpenCTI](#opencti) · [ThreatFox](#threatfox) · [URLhaus](#urlhaus) · [Elastic Detection Rules](#elastic-detection-rules) · [BloodHound](#bloodhound) · [Kubescape](#kubescape) · [FLARE-VM](#flare-vm) · [Frida](#frida) · [MobSF](#mobsf) · [GitHub Advisory Database](#github-advisory-database) · [Open Source Vulnerabilities](#open-source-vulnerabilities)
...
[Stratosphere IPS Datasets](#stratosphere-ips-datasets) · [UNB CIC Datasets](#unb-cic-datasets) · [Malpedia](#malpedia) · [MalwareBazaar](#malwarebazaar) · [Center for Threat-Informed Defense](#center-for-threat-informed-defense)
...
[The DFIR Report](#the-dfir-report) · [ROP Emporium](#rop-emporium) · [CyberDefenders](#cyberdefenders) · [LetsDefend](#letsdefend) · [OpenSecurityTraining2](#opensecuritytraining2) · [OverTheWire](#overthewire) · [PentesterLab](#pentesterlab) · [TryHackMe](#tryhackme)
...
[Apache Caldera](#apache-caldera) · [Atomic Red Team](#atomic-red-team) · [garak](#garak) · [PyRIT](#pyrit) · [CodeQL](#codeql) · [Stratus Red Team](#stratus-red-team) · [Trivy](#trivy) · [MISP](#misp) · [OpenCTI](#opencti) · [Elastic Detection Rules](#elastic-detection-rules) · [Google SecOps Community Rules](#google-secops-community-rules) · [Sigma](#sigma) · [Velociraptor](#velociraptor) · [Kubescape](#kubescape) · [FLARE-VM](#flare-vm) · [Frida](#frida) · [MobSF](#mobsf) · [Metasploit Documentation](#metasploit-documentation) · [GitHub Advisory Database](#github-advisory-database) · [Open Source Vulnerabilities](#open-source-vulnerabilities)
...
[Atomic Red Team](#atomic-red-team) · [garak](#garak) · [Promptfoo](#promptfoo) · [PyRIT](#pyrit) · [CodeQL](#codeql) · [OSS-Fuzz](#oss-fuzz) · [Semgrep](#semgrep) · [Prowler](#prowler) · [Stratus Red Team](#stratus-red-team) · [Trivy](#trivy) · [MISP](#misp) · [OpenCTI](#opencti) · [Elastic Detection Rules](#elastic-detection-rules) · [Exploit Database](#exploit-database) · [pwntools](#pwntools) · [ROP Emporium](#rop-emporium) · [BloodHound](#bloodhound) · [Kubescape](#kubescape) · [FLARE-VM](#flare-vm) · [Malpedia](#malpedia) · [MalwareBazaar](#malwarebazaar) · [REMnux](#remnux) · [VirusTotal](#virustotal) · [YARA](#yara) · [Frida](#frida) · [MobSF](#mobsf) · [GitHub Advisory Database](#github-advisory-database) · [Open Source Vulnerabilities](#open-source-vulnerabilities)
...
[USENIX Security Symposium](#usenix-security-symposium) · [Velociraptor](#velociraptor) · [LiveOverflow](#liveoverflow) · [OpenSecurityTraining2](#opensecuritytraining2)
