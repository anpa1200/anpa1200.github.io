  ...
  for (const object of sourcePrimary) {
    ...
    if (isAdversaryGraph) {
      ...
      Object.assign(normalized, {
        ...
        releaseNotes: `${factValue('adversarygraph.repository_url')}/blob/${factValue('adversarygraph.current_source_commit')}/docs/release-notes/${factValue('adversarygraph.current_source_release')}.md`,
        license: license.url,
