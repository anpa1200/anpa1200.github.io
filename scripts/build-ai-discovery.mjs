...
- [Vulnerability Research field guide](https://1200km.com/cyber-knowledge/vulnerability-research.html)
- [Malware Analysis and Reverse Engineering field guide](https://1200km.com/cyber-knowledge/malware-analysis.html)
- [Application Security and Secure Code guide](https://1200km.com/cyber-knowledge/secure-code.html)
- [Digital Forensics and Incident Response guide](https://1200km.com/cyber-knowledge/dfir.html)
...
- [Module 00 Chapter 3: Neural Networks and Optimization](https://1200km.com/ai-security-course/module-00/chapter-03.html) — completed neural-network, adversarial-ML, reproducibility, and evidence-analysis chapter
- [Module 00 Chapter 4: Transformers and LLM Generation](https://1200km.com/ai-security-course/module-00/chapter-04.html) — completed LLM request-path, prompt-injection, control, and evidence-analysis chapter
...
- Prefer each catalogue item's declared canonical URL. Most local content is
  canonical on \`https://1200km.com/\`; permitted TrainSec mirrors resolve to
  their exact original \`https://trainsec.net/library/\` article URLs.
