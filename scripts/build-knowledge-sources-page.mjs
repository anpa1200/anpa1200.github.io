...
const PAGE = {
  path: 'cyber-knowledge/knowledge-sources/index.html',
  active: 'cyber-knowledge',
  back_to_top: true,
};
...
<html lang="en" data-theme="light">
  <head>
    ...
    <meta name="description" content="Search and compare 125 assessed cybersecurity knowledge sources across government guidance, frameworks, threat research, DFIR, cloud, application security, training, and more." />
    <meta name="author" content="Andrey Pautov" />
    <meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1" />
    <meta name="theme-color" content="#f5f5f4" />
    <meta name="pagefind:filter" content="section:Cyber Knowledge" />
    <meta name="pagefind:meta" content="collection:Knowledge Sources" />
    ...
    <meta name="twitter:description" content="Search and compare 125 assessed cybersecurity knowledge sources with quality, access, audience, and evidence-use context." />
...
${categorySections}
          ...
          <section class="ks-methodology" id="methodology" aria-labelledby="methodology-title">
            ...
            <p class="ks-method-links">For sources directly cited inside the practitioner guides, use the separate <a href="/cyber-knowledge/sources/">citation inventory</a>. For correction and evidence rules, read the <a href="/cyber-knowledge/editorial-policy/">editorial and source policy</a>.</p>
          </section>
        </div>
      </div>
    </main>
