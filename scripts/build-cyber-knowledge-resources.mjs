...
const sourcesBody = `<section aria-labelledby="source-index-title">
        ...
        <aside class="notice" aria-label="Related curated source catalog">
          <span aria-hidden="true">↗</span>
          <div><strong>Need a curated learning catalog?</strong><p>This page records citations actually used by the field guides. The <a href="/cyber-knowledge/knowledge-sources/">Knowledge Sources module</a> separately assesses ${knowledgeSourceCount} standards, research portals, tools, datasets, and training resources with descriptions, quality dimensions, tags, and crosslinks.</p></div>
        </aside>
...
const policyBody = `<section aria-labelledby="policy-title">
        ...
        <div class="domain-grid">
          <article class="domain-card"><h3 class="domain-title">Source selection</h3><p class="domain-desc">Prefer official standards, government publications, framework owners, first-party documentation, peer-reviewed research, and technically credible primary research. Internal 1200km material is labelled as research, a lab, a tool, or a workflow—not as an external standard. The <a href="/cyber-knowledge/knowledge-sources/">Knowledge Sources module</a> records the scope, strengths, limitations, quality dimensions, and intended use of its curated entries.</p></article>
