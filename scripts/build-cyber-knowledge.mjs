  ...
  return `      <!-- cyber-knowledge:ecosystem:start -->
      <section id="ecosystem" aria-labelledby="ecosystem-title">
        ...
        <div class="domain-grid ecosystem-grid">
          ...
          <article class="domain-card"><span class="domain-index">Curated sources</span><h3 class="domain-title"><a href="/cyber-knowledge/knowledge-sources/">Knowledge Sources</a></h3><p class="domain-desc">Search ${knowledgeSourceCount} assessed cybersecurity standards, research portals, tools, datasets, and learning resources by category, tag, audience, access, and quality.</p></article>
