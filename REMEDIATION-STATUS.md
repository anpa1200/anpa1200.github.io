...
- Governed article-archive commit: `c4047aa1d66434e294ff96ea7cedff38a0e5b565`
...
| 2 — article canonical migration | In progress | Archive [PR #5](https://github.com/anpa1200/medium-blog-navigation/pull/5) merged. All 177 items now have governed local canonicals, original-publication provenance, intrinsic image dimensions, and an explicit migration state. External publication settings still require manual verification. |
...
- Article governance: archive [PR #5](https://github.com/anpa1200/medium-blog-navigation/pull/5), merged at `c4047aa1d66434e294ff96ea7cedff38a0e5b565`.
