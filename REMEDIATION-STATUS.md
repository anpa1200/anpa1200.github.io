...
| 4 — search governance | In progress | Controlled core/reference/archive tiers, item-level provenance, evidence-aware Pagefind weighting, a visible tier facet, and exact/broad/archive regression coverage pass locally; review and production verification remain pending. |
