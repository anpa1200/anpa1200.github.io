...
| 5 — structured data and SEO | In progress | The homepage `FAQPage` misuse, incomplete article entities, legacy meta-keywords, documentation title suffixes, and date/canonical semantic enforcement are being corrected at the release-generation layer. |
