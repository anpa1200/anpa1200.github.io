# 1200km production remediation status — historical July 2026 snapshot

Last updated: 2026-07-22

This file preserves the July 2026 remediation baseline. It is not a source for
current release or deployment claims; use `data/site-facts.json` and the latest
production-verification artifact for current state.
...
- AdversaryGraph state recorded for this baseline: source `v6.5.0`, merged and CI-validated 2026-07-25 ([source notes](https://github.com/anpa1200/adversarygraph/blob/aeee13dcaec1e2993b9f0969290c9ee414bb4cf6/docs/release-notes/v6.5.0.md)); published release `v6.0.0`, published 2026-07-17 ([release](https://github.com/anpa1200/adversarygraph/releases/tag/v6.0.0))
...
| 8 — AdversaryGraph presentation | In progress at baseline | v6.5.0 source evidence was separated from the then-published v6.0.0 tag boundary. |
