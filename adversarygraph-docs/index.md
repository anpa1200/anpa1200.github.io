...
The documentation is public. The running platform can include private analysis, authenticated workflows, malware-analysis handoff, attack simulation labs, and SIEM forwarding, but those operations are not exposed through the public documentation site.
