...
Medium companion: *Not published. This canonical course page is the authoritative Chapter 4 edition.*
...
The chapter uses text-native diagrams instead of raster infographics so the logical stages remain selectable, accessible, searchable, and easy to revise. Learners should treat them as architecture models, not packet-level or provider-specific implementation diagrams.
