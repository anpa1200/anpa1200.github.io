...
Capture window: 2022-02-23T18:22:24.405139+00:00 to 2022-02-23T19:07:05.141800+00:00 UTC.
Capture SHA-256: `eefc7e61b50e7846f5a3282d7645539d7b2b4b85aa08a09d0b823896c9449d1f`.
Analysis ID: `43bc93eb-d6db-4400-b983-b0dd404c8ca4`; review session: `bfa8693a-227f-4f5d-8e70-aff8c425ac42`.
First real HTTP upload/analysis: **14.594 seconds**. Fresh uncached decoder repeat: **16.462 seconds**. Prior isolated upload: 12.500 seconds.
...
Cross-case links: 11; independently verified: True. These are shared observations, predominantly common service infrastructure, not common-campaign assertions.
...
[Publisher answer](https://www.malware-traffic-analysis.net/2022/02/23/page2.html).
...
- `156.96.154.210`: present
- `www.katchybugonsale.com`: present
- `www.privilegetroissecurity.com`: present
- `www.hentainftxxx.com`: present
- `www.moonshot.properties`: present
- `www.nt-renewable.com`: present
- `www.elsiepupz.com`: present
- `www.jogoreviravolta.com`: present
- `www.seo-python.com`: present
- `www.db-propertygroup.com`: present
- `www.xn--pckwb0cye6947ajzku8opzi.com`: present
- `www.czzhudi.com`: present
- `www.hydrocheats.com`: present
- `www.riskprotek.com`: present
- `www.campdiscount.info`: present
- `www.mystore.guide`: present
- `www.theperfecttrainer.com`: present
- `www.globalsovereignbank.com`: present
- `www.keysine.com`: present
- `www.chinadqwx.com`: present
- `www.awridahmed.com`: present
- `www.ban-click.com`: present
- `www.byaliciafryearson.com`: present
- `www.krpano.pro`: present
- `www.barrcoplumbingsupply.com`: present
- `www.32342240.xyz`: present
- `www.jmtmjz.com`: present
- `www.freedomteaminc.com`: present
- `www.centroimprenta.xyz`: present
- `www.e-scooters.frl`: present
- `www.klassociates.info`: present
- `dalgahavuzu.com`: present
- `www.ajaxmatters.com`: present
- `135.148.121.246`: present
- `144.217.88.125`: present
- `134.209.156.68`: present
- `14b57211308ac8ad2a63c965783d9ba1c2d1930d0cafd884374d143a481f9bf3`: present

## Complete-flow checks and evidence links

Browser history/open, Markdown export and investigation transfer: True. Investigation ID: `7ebcdf06-0ce2-42bb-aa0c-6cd478f63e57`.
...
- [Browser screenshot](../../browser/2022-02-23.png), [investigation evidence](../../browser/2022-02-23-investigation.json).
